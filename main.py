...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_description": "Some preprocessing step"
            }
        )
    ...
    if "check_data" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "sample_artifact": f'{config["main"]["project_name"]}/processed_data.csv:latest',
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": f'{config["main"]["project_name"]}/processed_data.csv:latest',
                "artifact_root": "data",
                "artifact_type": "data",
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "model_export": f'{config["main"]["project_name"]}/export_model:latest',
